...
public class Day12Brian extends DayBase
{
    ...
    for (String instruction : instructions)
    {
      ...
      int distance =
        Integer.valueOf(String
          .join("", instruction.subSequence(1, instruction.length())));
      // System.out.println("Instruction: " + instruction + " (" + direction +
      // ") (" + distance + ")");
      switch (direction)
      {
        case "N":
  ...
  public void solveB(List<String> instructions)
  {
    ...
    for (String instruction : instructions)
    {
      ...
      System.out.print(instruction + " S: " + shipEastWest + "E, "
        + shipNorthSouth + "N");
      System.out
        .println("  W: " + waypointEastWest + "E, " + waypointNorthSouth + "N");
      // System.out.println();
    }
